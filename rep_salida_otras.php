<?php
	...
	if (!isset($_SESSION['idUsuario'])) {
		...
		//include "genera_repSalidaIansa.php";
		// Reporte
		$prefijo = date("YmdHis");
		...
		if ($oper==0) {	
			if ($status==1) {
				...
				//			
				if ($sw_error==0) {	
					//$ok = GeneraReporte( $name, trim($f_inicio), trim($f_termino) );
					$ok = true;
				}
				$status=0;
			}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function exportar() {
		...
		document.location.href="exportar_repSalidaOtras.php?name=<?php echo $name2;?>&inicio=<?php echo $f_inicio;?>&termino=<?php echo $f_termino;?>";
	}
    </script>
    ...
    <body onLoad="inicio();">
    <form method="post" action="rep_salida_otras.php" target="_self" name="reporte" id="reporte" onSubmit="return false;">
    <!-- loading animation -->
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: white;">Salida Excel</li>
                    </ul>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    <h4>
                                        ...
                                        <span>Generaci&oacute;n Salida Excel</span>
                                    </h4>
                                </div>
                                <div class="content noPad" style="height: 50px;">
	                                <div class="form-row row-fluid" style="border: 0px red dotted;">
                                    	<span class="span1" style="border: 0px green dotted; margin-left: 10px; margin-top: 10px;"><input id="dp_f_inicio" name="f_inicio" type="text" value="<?php echo $f_inicio;?>" maxlength="10" placeholder="Inicio" /></span>
                                    	<span class="span1" style="border: 0px green dotted; margin-left: 10px; margin-top: 10px;"><input id="dp_f_termino" name="f_termino" type="text" value="<?php echo $f_termino;?>" maxlength="10" placeholder="Termino" /></span>
                                    	<span class="span2">&nbsp;</span>
										<?php
										if ($ok==true) { ?>
			                                <div class="btn-group span3" style="text-align: center; border: 0px blue dotted; margin-top: 10px;">
		                                        <button class="btn btn-success" title="Exportar a EXCEL" onClick="exportar();"><span class="icon16 white icomoon-icon-file-excel"></span>EXCEL</button>
		                                    </div>
		                                <?php } else { ?>
			                                <div class="btn-group span3" style="text-align: center; border: 0px blue dotted; margin-top: 10px;">
			                                	&nbsp;
		                                ...
		                                <?php } ?>    
                                    	<span class="span5" style="margin-left: 10px; text-align: right; border: 0px red dotted; margin-top: 10px;"><button class="btn btn-inverse" href="#" onClick="genReporte();">Generar</button></span>
	                                </div>
                                </div>
