...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function exportar() {
		...
		document.location.href="exportar_repSalidaIansa.php?name=<?php echo $name2;?>&inicio=<?php echo $f_inicio;?>&termino=<?php echo $f_termino;?>";
	}
    </script>
    ...
    <body onLoad="inicio();">
    <form method="post" action="rep_salida_iansa.php" target="_self" name="reporte" id="reporte" onSubmit="return false;">
    <!-- loading animation -->
