...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onLoad="inicio();">
    <form method="post" action="rendicion_interna.php" target="_self" name="rendicion" id="rendicion" onSubmit="return false;">
    <!-- loading animation -->
    ...
    <div id="wrapper">
		...
		if ($oper==0) {	// Visualizar
			...
			$rows_per_page= 100;
			$tiene_filtro = false;
			$query = "SELECT A.* from cargas_iansa A LEFT JOIN guias_iansa B ON A.id=B.asignacion_id ";
			$condicion = " WHERE A.estado = 1 AND B.estadoRC=0 ";
			$tiene_filtro = true;
			if ($f_carga <> "") {
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: white;">Rendici&oacute;n Interna IANSA</li>
                    </ul>
                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    <h4>
                                        ...
                                        <span>Rendici&oacute;n Interna IANSA</span>
                                    </h4>
                                </div>
	                                    ...
	                                    <div class="span12">
	                                        <div class="row-fluid" style="height: 42px;">
	                                            ...
	                                            <select name="f_patente" id="f_patente" class="nostyle mayuscula" style="width: 140px; min-width: 140px; height: 29px;">
													...
													<?php
														$query = "SELECT DISTINCT A.patente, C.id AS 'ID_PATENTE' FROM cargas_iansa A LEFT JOIN guias_iansa B ON A.id=B.asignacion_id LEFT JOIN patentes C ON A.patente=C.patente ".$condicion_patente." ORDER BY A.patente ASC";
														$result = mysqli_query($conn,$query);
														while ($row = mysqli_fetch_array($result))
														{
															if ($f_patente==$row["patente"]) {
                                    ...
                                    <table class="responsive table table-bordered">
                                        <thead>
                                          <tr>
                                            ...
                                            <th width="40" style="text-align: center;">Pallet</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                        <?php
										$contador=(($page-1)*($rows_per_page));
										$query = "SELECT A.*, B.id AS 'ID_GUIA', B.guia, B.estado AS 'EstadoGuia', B.CHEP, B.IANSA FROM cargas_iansa A LEFT JOIN guias_iansa B ON A.id=B.asignacion_id ".$condicion." ORDER BY A.patente, guia ASC ";
										$query .= " $limit";
										...
										while ($row = mysqli_fetch_array($result))
										{
											...
											?>
	                                          <tr>
	                                            ...
	                                            <td style="text-align: center; vertical-align: middle;"><?php echo strtoupper(trim($row["ruta"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle;"><?php echo strtoupper(trim($row["nombre_destinatario"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle; font-size: 100%;"><?php echo strtoupper(trim($row["rut_chofer"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle; font-size: 100%;"><?php echo strtoupper(trim($row["nombre_chofer"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle; font-size: 110%; font-weight: bold;"><?php echo strtoupper(trim($row["patente"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle; font-size: 100%;"><?php echo strtoupper(trim($row["causante"]));?></td>
	                                            <td style="text-align: left; vertical-align: middle; font-size: 110%; font-weight: bold;"><?php echo strtoupper(trim($row["guia"]));?></td>
	                                            <?php
	                                            if (is_null($row["EstadoGuia"]) || $row["EstadoGuia"] > 2) { ?>
		                                            <td style="text-align: center;">&nbsp;</td>
		                                        <?php } else { 
	                                            if ($row["EstadoGuia"]==0) { ?>
		                                            <td style="text-align: center;"><a href="#" onClick="cambiar('1', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_1_<?php echo trim($contador);?>" id="img_1_<?php echo trim($contador);?>" src="images/_enruta_si.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('2', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_2_<?php echo trim($contador);?>" id="img_2_<?php echo trim($contador);?>" src="images/_rendok_no.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('3', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_3_<?php echo trim($contador);?>" id="img_3_<?php echo trim($contador);?>" src="images/_pendie_no.png" style="cursor: pointer;"></a></td>
		                                        <?php } else { 
	                                            if ($row["EstadoGuia"]==1) { ?>
		                                            <td style="text-align: center;"><a href="#" onClick="cambiar('1', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_1_<?php echo trim($contador);?>" id="img_1_<?php echo trim($contador);?>" src="images/_enruta_no.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('2', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_2_<?php echo trim($contador);?>" id="img_2_<?php echo trim($contador);?>" src="images/_rendok_si.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('3', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_3_<?php echo trim($contador);?>" id="img_3_<?php echo trim($contador);?>" src="images/_pendie_no.png" style="cursor: pointer;"></a></td>
		                                        <?php } else { 
	                                            if ($row["EstadoGuia"]==2) { ?>
		                                            <td style="text-align: center;"><a href="#" onClick="cambiar('1', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_1_<?php echo trim($contador);?>" id="img_1_<?php echo trim($contador);?>" src="images/_enruta_no.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('2', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_2_<?php echo trim($contador);?>" id="img_2_<?php echo trim($contador);?>" src="images/_rendok_no.png" style="cursor: pointer;"></a>&nbsp;&nbsp;&nbsp;<a href="#" onClick="cambiar('3', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_3_<?php echo trim($contador);?>" id="img_3_<?php echo trim($contador);?>" src="images/_pendie_si.png" style="cursor: pointer;"></a></td>
		                                        <?php }
	                                        		} 
                                    			}} 
	                                            if (is_null($row["EstadoGuia"]) || $row["EstadoGuia"] > 2) { ?>
		                                        ...
		                                        <?php } else { 
		                                            if (is_null($row["CHEP"]) && is_null($row["IANSA"])) { ?>
			                                            <td style="text-align: center;"><a href="#" onClick="cambiar('4', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_4_<?php echo trim($contador);?>" id="img_4_<?php echo trim($contador);?>" src="images/_pallet_no.png" style="cursor: pointer;"></a></td>
			                                        <?php } else { ?>
			                                            <td style="text-align: center;"><a href="#" onClick="cambiar('4', '<?php echo trim($contador);?>', <?php echo trim($row['ID_GUIA']);?>);"><img name="img_4_<?php echo trim($contador);?>" id="img_4_<?php echo trim($contador);?>" src="images/_pallet_si.png" style="cursor: pointer;"></a></td>
			                                        <?php } 
		                                        }
                                    			?>    
	                                          </tr>
