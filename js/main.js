...
$(document).ready(function() { 	
	...
	$( '.collapseBtn' ).bind( 'click', function(){
		...
		if($(this).hasClass('hide')) {
			...
			$('.collapseBtn').css('top', '70'+'px').css('left', '180'+'px').removeClass('shadow');
			$this.children('a').attr('title','Ocultar Menu');
			...
			//expand content
			$this.addClass('hide');
			$this.children('a').attr('title','Mostrar Menu')
...
*/
	...
	if ($('textarea').hasClass('limit255')) {
		$('.limit255').inputlimiter({
			limit: 255
		});
	}
    ...
    $("#form-validate").validate({
		...
		messages: {
			...
			password: {
				required: "Favor indicar Password.",
				minlength: "Su Password debe ser de al menos 3 caracteres."
			},
			confirm_password: {
				required: "Favor confirmar Password.",
				minlength: "Su Password debe ser de al menos 3 caracteres.",
				equalTo: "Ingrese la misma Password para Confirmar."
			},
			email: "Ingrese un email valido.",
			si_email: "Ingrese un email valido.",
